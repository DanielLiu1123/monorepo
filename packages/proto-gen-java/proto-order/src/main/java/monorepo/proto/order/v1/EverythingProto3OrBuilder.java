...
public interface EverythingProto3OrBuilder extends
    // @@protoc_insertion_point(interface_extends:order.v1.EverythingProto3)
...
monorepo.proto.order.v1.EverythingProto3.Enum         defaultValue);
   ...
   * @return The eValue.
   */
  monorepo.proto.order.v1.EverythingProto3.Enum getEValue();
   ...
   */
  java.util.List<monorepo.proto.order.v1.EverythingProto3.Enum> getReptEnumValueListList();
  /**
   * <code>repeated .order.v1.EverythingProto3.Enum rept_enum_value_list = 107 [json_name = "reptEnumValueList"];</code>
   ...
   */
  monorepo.proto.order.v1.EverythingProto3.Enum getReptEnumValueList(int index);
  /**
   * <code>repeated .order.v1.EverythingProto3.Enum rept_enum_value_list = 107 [json_name = "reptEnumValueList"];</code>
...
monorepo.proto.order.v1.EverythingProto3.Enum         defaultValue);
   ...
   * <code>map&lt;string, .order.v1.EverythingProto3.Enum&gt; m_string_enum_map = 104 [json_name = "mStringEnumMap"];</code>
   */
  monorepo.proto.order.v1.EverythingProto3.Enum getMStringEnumMapOrThrow(
      java.lang.String key);
  /**
